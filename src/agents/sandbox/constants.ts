...
import { resolveHomeDir, STATE_DIR } from "../../config/config.js";

export const DEFAULT_SANDBOX_WORKSPACE_ROOT = path.join(resolveHomeDir(), ".openclaw", "sandboxes");
...
const resolvedSandboxStateDir = STATE_DIR ?? path.join(resolveHomeDir(), ".openclaw");
