...
### Changes
- Learning: add Thompson Sampling bandit for active prompt composition with Beta-Bernoulli conjugate updates, seed arm protection, baseline comparison, and dashboard visualizations. (#33)
